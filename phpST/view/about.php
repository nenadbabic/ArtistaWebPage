...
<div class="jumbotron">
    <div class="container">
        <p>My name is Gregor Sintič and I am a student of UL FRI. This is my school project.</p>
        <ul>
            <li><a href="https://ucilnica.fri.uni-lj.si/" style="color: white; font-size: 20px;">Spletna učilnica FRI</a></li>
            <li><a href="http://getbootstrap.com/" style="color: white; font-size: 20px;">I used BootStrap</a></li>
            <li><a href="http://www.flaticon.com" style="color: white; font-size: 20px;">Icons used here were made by Freepik from www.flaticon.com</a></li>
        </ul>
