                        ...
                        <div class="col-md-9 personal-info">
                            ...
                            <form class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="button" class="btn btn-primary" value="Shrani spremembe">
                                        <span></span>
                                        <input type="reset" class="btn btn-default" onclick="window.location='mainpage.html';" value="Prekliči">
                                    </div>
                                </div>
                            </form>
                        </div>
