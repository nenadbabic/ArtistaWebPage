                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <form class="form" role="form" method="post" action="login" accept-charset="UTF-8" id="login-nav">
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputEmail2">E-naslov</label>
                                            <input type="email" class="form-control" id="exampleInputEmail2" placeholder="E-naslov" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only" for="exampleInputPassword2">Geslo</label>
                                            <input type="password" class="form-control" id="exampleInputPassword2" placeholder="Geslo" required>
                                            <div class="help-block text-right"><a href="">Ste pozabili geslo?</a></div>
                                        </div>
                                        <div class="form-group">
